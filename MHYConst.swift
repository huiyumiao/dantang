...
enum MHYOtherLoginButtonType: Int {
    /// 微博
    case weiboLogin = 100
    /// 微信
...
/// 第一次启动
let MHYFirstLaunch = "firstLaunch"
/// 是否登录
let isLogin = "isLogin"
...
/// 我的界面头部图像的高度
let kMHYMineHeaderImageHeight: CGFloat = 200
// 分享按钮背景高度
let kTopViewH: CGFloat = 230


/// RGBA的颜色设置
func MHYColor(r:CGFloat, g:CGFloat, b:CGFloat, a:CGFloat) -> UIColor {
    return UIColor(red: r / 255.0, green: g / 255.0, blue: b / 255.0, alpha: a)
}

/// 背景灰色
func MHYGlobalColor() -> UIColor {
    return MHYColor(r: 240, g: 240, b: 240, a: 1)
}

/// 红色
func MHYGlobalRedColor() -> UIColor {
    return MHYColor(r: 245, g: 80, b: 83, a: 1.0)
}
